...
var initProgram = setTimeout(function () {
  ...
  var message = "RUNNING CODEPEN RESUME PROTOCAL (CRP) FOR @harturicko";
  var $identityDiv = $("#identity-results");
  var $name = "NAME: Artur Omelian";
  var $alias = "KNOWN ALIAS: HARTURICKO";
  var $occupation = "OCCUPATION: CYBERSECURITY STUDENT";
  var $frontEnd =
    "CORE SKILLS: JAVA | SPRING BOOT | SQL | JAVASCRIPT | AWS | HTML | CSS | JS";
  var $JSFrameworks = "BACK-END FRAMEWORKS: SPRING BOOT";
  var $JSLibs = "ADDITIONAL TOOLS: JWT | MVC | REST APIs";
  var $CSSFrameworks = "NETWORKING: CISCO PACKET TRACER | VLANs | ROUTING";
  var $CSSPre = "DATABASE: SQL | PERFORMANCE OPTIMIZATION";
  var $frontEndAnimation = "SECURITY PRACTICES: AUTHENTICATION | API SECURITY";
  var $cmsDevelopment =
    "PROJECTS: FULL-STACK WEB APP | ENTERPRISE NETWORK DESIGN";
  var $wordpress = "TOOLS: GIT | LINUX | FIREWALL CONFIGURATION";
  var $design = "SOFT SKILLS: TEAMWORK | PROBLEM SOLVING | ADAPTABILITY";
  var $webDesign = "LANGUAGES: UKRAINIAN (NATIVE) | ENGLISH (B2) | POLISH (B1)";
  var $branding = "EDUCATION: LVIV POLYTECHNIC | 2021–2026";
  var $designAnimation = "CERTIFICATIONS: SOFTSERVE JAVA COURSE (2023)";
  ...
  function initIdentityResults(i) {
    ...
    function initJSFrameworks(i) {
      $("#js-frameworks")
        .addClass("sign cursor")
        .text($JSFrameworks.substring(0, i));
    ...
    function initCSSFrameworks(i) {
      $("#css-frameworks")
        .addClass("sign cursor")
        .text($CSSFrameworks.substring(0, i));
    ...
    function initFrontEndAnimation(i) {
      $("#front-end-animation")
        .addClass("sign cursor")
        .text($frontEndAnimation.substring(0, i));
    ...
    function initCMSDevelopment(i) {
      ...
      $("#CMS-development")
        .addClass("cursor")
        .text($cmsDevelopment.substring(0, i));
    ...
    function initDesignAnimation(i) {
      $("#design-animation")
        .addClass("sign cursor")
        .text($designAnimation.substring(0, i));
